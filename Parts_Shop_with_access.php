...
if (isset($_GET['model'])) {
    $model = $_GET['model'];
    // Utilizza il tag script per definire una variabile JavaScript con il valore del modello
    echo "<script>var bikeModel = '" . htmlspecialchars($model) . "';</script>";
} else {
    // Se non viene specificato alcun modello, la variabile avrà un valore vuoto
